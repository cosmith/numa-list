# Fact-check — lot 02 (indices 40 à 79)

Vérification effectuée le 21 août 2026 à partir de sources web, sans navigateur graphique. Les appartenances aux cohortes sont généralement bien établies par les annonces contemporaines de Maddyness, Journal du Net, Wydden et TechCrunch. Les statuts « stoppé » fondés uniquement sur l'absence de résultats récents ont été classés non vérifiables.
...
- Pulpix : le profil Y Combinator confirme une acquisition par Adyoulike en 2019, pas par Teads en 2016.
- CoursierPrivé.com : pivot vers Swoopin puis liquidation judiciaire en 2022.
...
Le détail champ par champ, les correctifs proposés et les URLs de preuve figurent dans `batch-02.json`.
